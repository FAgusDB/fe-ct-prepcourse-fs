...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   var resultados = 0
   for(var propiedad in objetoUsuario.posts){
      resultados = resultados + objetoUsuario.posts[propiedad].likes
   }
   return resultados   
}
